import os
"""
Django settings for SIMOS project.
...
SECRET_KEY = 'django-insecure-0v9gsqm2$o4srev(!69_^jt=imuvos1-s6l*8$levo5ec&$!z&'
...
CSRF_TRUSTED_ORIGINS = ['https://*.railway.app','https://simos.site']
...
WSGI_APPLICATION = 'SIMOS.wsgi.application'
